...
var PieceValueMG = [6]int16{93, 353, 365, 480, 978}
var PieceValueEG = [6]int16{117, 252, 279, 497, 932}

var PieceMobilityMG = [5]int16{0, 5, 4, 5, 0}
...
var RookOrQueenOnSeventhBonusEG int16 = 18

var KnightOnOutpostBonusMG int16 = 19
...
var PSQT_MG = [6][64]int16{
	{
		// MG Pawn PST
		0, 0, 0, 0, 0, 0, 0, 0,
		53, 72, 39, 53, 35, 46, 12, 1,
		-26, -14, 4, 9, 44, 47, 6, -28,
		-26, -4, -3, 15, 13, 5, 0, -27,
		-37, -24, -7, 6, 10, 1, -12, -32,
		-30, -24, -9, -9, 1, 0, 9, -17,
		-35, -18, -26, -16, -11, 18, 18, -22,
		0, 0, 0, 0, 0, 0, 0, 0,
	},
	{
		// MG Knight PST
		...
		-29, 36, 18, 39, 54, 66, 44, 12,
		-12, 10, 0, 35, 16, 49, 5, 8,
		-10, 0, 12, 6, 20, 11, 10, -9,
		-19, -6, 9, 13, 24, 16, 20, -11,
		-22, -33, -8, 9, 10, 18, -7, -12,
		-37, -8, -37, -21, -2, -15, -6, -19,
	},
	{
		// MG Bishop PST
		-13, -4, -26, -12, -7, -12, -1, 0,
		-21, 0, -24, -17, 2, 17, 0, -49,
		-21, 15, 18, 10, 4, 23, 6, -9,
		-8, 0, 0, 25, 13, 9, 0, -10,
		-4, 3, 0, 13, 17, -2, 0, 2,
		0, 12, 14, 4, 10, 26, 13, 5,
		1, 21, 10, 5, 13, 20, 38, 2,
		-23, 0, 1, -2, 0, 0, -17, -16,
	},
	{
		// MG Rook PST
		9, 17, 0, 21, 18, -1, 0, 2,
		10, 9, 36, 33, 36, 32, 0, 9,
		-11, 4, 8, 9, -2, 9, 25, -1,
		-25, -14, 0, 5, 0, 12, -6, -20,
		-36, -18, -7, -4, 0, -10, 0, -27,
		-31, -14, -3, -6, 0, 0, -6, -26,
		-26, -6, -5, 3, 7, 9, 0, -48,
		-2, 2, 16, 24, 23, 17, -16, -3,
	},
	{
		// MG Queen PST
		-18, -1, 0, 0, 25, 13, 11, 20,
		-19, -46, -3, 0, -6, 16, 7, 21,
		-10, -13, -1, -7, 10, 29, 17, 27,
...
var PSQT_EG [6][64]int16 = [6][64]int16{
	{
		...
		12, 24, 22, 9, 0, -11, 15, 12,
		-16, -24, -29, -41, -36, -31, -30, -25,
		-22, -24, -34, -38, -38, -38, -37, -36,
		-32, -30, -36, -30, -30, -35, -45, -43,
		-24, -33, -19, -25, -21, -34, -43, -44,
		0, 0, 0, 0, 0, 0, 0, 0,
	},
	{
		// EG Knight PST
