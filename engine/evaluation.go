...
var PieceValueMG = [6]int16{84, 333, 347, 442, 921}
var PieceValueEG = [6]int16{106, 244, 269, 478, 887}
...
var PSQT_MG = [6][64]int16{
	{
		// MG Pawn PST
		0, 0, 0, 0, 0, 0, 0, 0,
		45, 52, 42, 43, 28, 34, 20, 10,
		-14, -3, 8, 14, 35, 50, 15, -7,
		-28, -6, -8, 13, 16, 4, -3, -25,
		-33, -28, -7, 5, 7, -1, -15, -31,
		-30, -26, -12, -12, -1, -5, 6, -17,
		-34, -23, -28, -18, -14, 10, 13, -22,
		0, 0, 0, 0, 0, 0, 0, 0,
	},
	{
		// MG Knight PST
	...
	},
	{
		...
		-8, 5, 1, -8, -10, -10, -9, -23,
		-4, 5, 1, -8, -12, -12, 8, -24,
		6, 13, -1, -40, -24, -1, 25, 19,
		-28, 29, 17, -53, 3, -25, 34, 15,
	},
}
...
var PSQT_EG [6][64]int16 = [6][64]int16{
	{
		...
		18, 12, 12, 11, 11, -6, 15, 9,
		-4, -14, -18, -32, -29, -26, -20, -18,
		-13, -14, -25, -32, -30, -28, -27, -28,
		-22, -21, -26, -21, -22, -25, -35, -34,
		-16, -22, -12, -19, -14, -23, -32, -35,
		0, 0, 0, 0, 0, 0, 0, 0,
	},
	{
		// EG Knight PST
	...
	},
	{
		...
		-1, 18, 19, 15, 16, 35, 34, 5,
		-12, 14, 21, 25, 19, 25, 18, -6,
		-23, -6, 14, 21, 20, 18, 5, -16,
		-21, -6, 5, 13, 15, 10, -2, -12,
		-27, -10, 2, 9, 9, 1, -13, -26,
		-43, -34, -21, -6, -26, -9, -35, -55,
	},
}
...
var PassedPawnPSQT_MG = [64]int16{
	0, 0, 0, 0, 0, 0, 0, 0,
	45, 52, 42, 43, 28, 34, 20, 10,
	48, 43, 43, 30, 24, 31, 12, 3,
	28, 18, 14, 10, 10, 19, 7, 2,
	14, 0, -9, -7, -13, -7, 9, 17,
	5, 3, -3, -14, -3, 10, 13, 20,
	8, 10, 2, -8, -3, 9, 16, 9,
	0, 0, 0, 0, 0, 0, 0, 0,
